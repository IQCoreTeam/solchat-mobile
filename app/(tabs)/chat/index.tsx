...
const [localIsUserInitialized, setLocalIsUserInitialized] = useState(isUserInitialized);
useEffect(() => {
    ...
    const interval = setInterval(async () => {
      try {
        ...
        if (balance > 0) {
          ...
          setHistory(prev => [...prev, { id: uniqueId(), output: '[Server] Wallet funded and initialized! You can now create or join chatrooms.' }]);
        }
      } catch (error) {
